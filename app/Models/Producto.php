...
class Producto extends Model
{
     ...
     */
    public function refreshEstado($cantidad_db): void
    {
        ...
        } elseif ($cantidad_db <= $stockMinimo) {
    ...
    { 
        // print_r($this->getOriginal('cantidad'));
        // exit;
        $cantidad_db=$this->getOriginal('cantidad');
        $cantidad_db+= $cantidad;
       
        $this->refreshEstado($cantidad_db);
        $this->save();
    }
}