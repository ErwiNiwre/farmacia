						...
						<div class="row">
							<div class="col-6">
								<div class="bg-lightest px-30 py-40 rounded20 mb-20">
									...
									<a href="#" class="text-white fw-500 fs-18"  data-bs-toggle="modal" data-bs-target="#modal-ventas-fecha">
										Ventas por Fecha
									</a>
								</div>
							</div>
							<div class="col-6">
								<div class="bg-lightest px-30 py-40 rounded20 mb-20">
									<span class="mdi mdi-cash-multiple d-block fs-40"><span class="path1"></span><span class="path2"></span></span>
									<a href="#" class="text-white fw-500 fs-18" data-bs-toggle="modal" data-bs-target="#modal-productos-vendidos">
				...
				<div class="box">		
					...
					<div class="box-body up-mar60 pb-0">	
						<div class="row">
							<div class="col-6">
								<div class="bg-lightest px-30 py-40 rounded20 mb-20">
									<span class="mdi mdi-cart d-block fs-40"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></span>
									<a href="#" class="text-primary fw-500 fs-18" data-bs-toggle="modal" data-bs-target="#modal-compras-fecha">
										Compras por Fecha
									</a>
								</div>
							</div>
							<div class="col-6">
								<div class="bg-lightest px-30 py-40 rounded20 mb-20">
									<span class="mdi mdi-cart-plus d-block fs-40"><span class="path1"></span><span class="path2"></span></span>
									<a href="#" class="text-primary fw-500 fs-18" data-bs-toggle="modal" data-bs-target="#modal-productos-mas-comprados">
				...
				<div class="box">		
					...
					<div class="box-body up-mar60 pb-0">	
						<div class="row">
							<div class="col-6">
								<div class="bg-lightest px-30 py-40 rounded20 mb-20">
									<span class="mdi mdi-close-octagon d-block fs-40"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></span>
									<a href="#" class="text-warning fw-500 fs-18"  data-bs-toggle="modal" data-bs-target="#modal-productos-caducos">
										Productos Caducados
									</a>
								</div>
							...
							<div class="col-6">
								<div class="bg-lightest px-30 py-40 rounded20 mb-20">
									<span class="mdi  mdi-clock-alert d-block fs-40"><span class="path1"></span><span class="path2"></span></span>
									<a href="#" class="text-warning fw-500 fs-18" data-bs-toggle="modal" data-bs-target="#modal-productos-por-caducar">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-xxxl-12">
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input id="fecha_inicio" class="form-control" type="date" value="{{ date('Y-m-d') }}" name="fecha_inicio" >
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input id="fecha_fin" type="date" class="form-control"  value="{{ date('Y-m-d') }}" name="fecha_fin">
                                ...
                                <select id ="formato_ventas_fecha" class="form-control select2" style="width: 100%;">
                               ...
                               <div class="col">
                                ...
                                <select id ="tipo_movimiento" class="form-control select2" style="width: 100%;">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-xxxl-12">
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label class="form-label">Desde</label>
                                            <input id="fecha_inicio_p_v" class="form-control" type="date" value="{{ date('Y-m-d') }}" name="fecha_inicio_p_v" >
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label class="form-label">Hasta</label>
                                            <input id="fecha_fin_p_v" type="date" class="form-control"  value="{{ date('Y-m-d') }}" name="fecha_fin_p_v">
							  ...
							  <div class="col">
                                  <div class="form-group">
                                <label class="form-label">Tipo de Movimiento</label>
                                <select id ="tipo_movimiento_p_v" class="form-control select2" style="width: 100%;">
													<option selected="selected">Todos</option>
													<option>Venta</option>
                                                    <option>Salida Directa</option>
                                                    <option>Cuentas por Cobrar</option>
                               ...
                               <div class="col">
                                ...
                                <input id="cantidad_p_v" type="number" class="form-control"  value="10" name="cantidad_p_v">
                            </div>
                              </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-xxxl-12">
							  ...
							  <div class="col">
                                  <div class="form-group">
                                <label class="form-label">Tipo de Movimiento</label>
                                <select id ="tipo_movimiento_p_c" class="form-control select2" style="width: 100%;">
													<option selected="selected">Todos</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-xxxl-12">
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input id="fecha_limite_p_p_c" class="form-control" type="date" value="{{ date('Y-m-d') }}" name="fecha_inicio_p_v" >
                                  ...
                                  <div class="form-group">
                                <label class="form-label">Formato</label>
                                <select id ="formato_p_p_c" class="form-control select2" style="width: 100%;">
													<option selected="selected">PDF</option>
													<option>Excel</option>
												</select>
                            </div>
							  ...
							  <div class="col">
                                  <div class="form-group">
                                <label class="form-label">Tipo de Movimiento</label>
                                <select id ="tipo_movimiento_p_p_c" class="form-control select2" style="width: 100%;">
													<option selected="selected">Todos</option>
													<option>Compra</option>
                                                    <option>Ingreso Directo</option>
												</select>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-xxxl-12">
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label class="form-label">Desde</label>
                                            <input id="fecha_inicio_c" class="form-control" type="date" value="{{ date('Y-m-d') }}" name="fecha_inicio" >
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label class="form-label">Hasta</label>
                                            <input id="fecha_fin_c" type="date" class="form-control"  value="{{ date('Y-m-d') }}" name="fecha_fin">
                               ...
                               <div class="col">
                                  <div class="form-group">
                                <label class="form-label">Tipo de Movimiento</label>
                                <select id ="tipo_movimiento_c" class="form-control select2" style="width: 100%;">
													<option selected="selected">Todos</option>
													<option>Compra</option>
                                                    <option>Ingreso Directo</option>
												</select>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-xxxl-12">
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label class="form-label">Desde</label>
                                            <input id="fecha_inicio_p_m_c" class="form-control" type="date" value="{{ date('Y-m-d') }}" name="fecha_inicio_p_m_c" >
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label class="form-label">Hasta</label>
                                            <input id="fecha_fin_p_m_c" type="date" class="form-control"  value="{{ date('Y-m-d') }}" name="fecha_fin_p_m_c">
                                ...
                                <div class="row">
                                  ...
                                  <div class="form-group">
                                <label class="form-label">Formato</label>
                                <select id ="formato_p_m_c" class="form-control select2" style="width: 100%;">
													<option selected="selected">PDF</option>
													<option>Excel</option>
												</select>
                            </div>
							  ...
							  <div class="col">
                                  <div class="form-group">
                                <label class="form-label">Tipo de Movimiento</label>
                                <select id ="tipo_movimiento_p_m_c" class="form-control select2" style="width: 100%;">
													<option selected="selected">Todos</option>
													<option>Compra</option>
                                                    <option>Ingreso Directo</option>
												</select>
                               ...
                               <div class="col">
                                  <div class="form-group">
                                <label class="form-label">Cantidad de Productos</label>
                                <input id="cantidad_p_m_c" type="number" class="form-control"  value="10" name="cantidad_p_v">
                            </div>
                              </div>
...
@section('page-script')
 ...
 $('#reporteVentasFecha').on('submit', function(event) {
                ...
                let url = "{{ route('reportes.reporteVentasFecha', ['fecha_inicio' => ':fecha_inicio', 'fecha_fin' => ':fecha_fin', 'formato_ventas_fecha' => ':formato_ventas_fecha', 'tipo_movimiento' => ':tipo_movimiento']) }}";
			...
			$('#reporteProductosVendidos').on('submit', function(event) {
                ...
                let url = "{{ route('reportes.reporteProductosVendidos', ['fecha_inicio' => ':fecha_inicio', 'fecha_fin' => ':fecha_fin', 'formato' => ':formato', 'tipo_movimiento' => ':tipo_movimiento', 'cantidad' => ':cantidad']) }}";
                url = url.replace(':fecha_inicio', fecha_inicio_p_v).replace(':fecha_fin', fecha_fin_p_v).replace(':formato', formato_p_v)
            ...
            $('#reporteProductosCaducos').on('submit', function(event) {
                ...
                let url = "{{ route('reportes.reporteProductosCaducados', ['tipo_movimiento' => ':tipo_movimiento','formato' => ':formato']) }}";
              ...
              $('#reporteProductosPorCaducar').on('submit', function(event) {
                ...
                let url = "{{ route('reportes.reporteProductosPorCaducar', ['fecha_limite' => ':fecha_limite','tipo_movimiento' => ':tipo_movimiento','formato' => ':formato']) }}";
                url = url.replace(':fecha_limite', fecha_limite_p_p_c).replace(':tipo_movimiento', tipo_movimiento_p_p_c).replace(':formato', formato_p_p_c);
            ...
            $('#reporteComprasFecha').on('submit', function(event) {
                ...
                let url = "{{ route('reportes.reporteComprasFecha', ['fecha_inicio' => ':fecha_inicio', 'fecha_fin' => ':fecha_fin', 'formato' => ':formato', 'tipo_movimiento' => ':tipo_movimiento']) }}";
                url = url.replace(':fecha_inicio', fecha_inicio_c).replace(':fecha_fin', fecha_fin_c).replace(':formato', formato_c)
            ...
            $('#reporteProductosMasComprados').on('submit', function(event) {
                ...
                let url = "{{ route('reportes.reporteProductosMasComprados', ['fecha_inicio' => ':fecha_inicio', 'fecha_fin' => ':fecha_fin', 'formato' => ':formato', 'tipo_movimiento' => ':tipo_movimiento', 'cantidad' => ':cantidad']) }}";
                url = url.replace(':fecha_inicio', fecha_inicio_p_m_c).replace(':fecha_fin', fecha_fin_p_m_c).replace(':formato', formato_p_m_c)
				.replace(':tipo_movimiento', tipo_movimiento_p_m_c).replace(':cantidad', cantidad_p_m_c);
