...
<section class="content">
    {{-- <div class="row">
                        ...
                        <div class="box-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h3 class="mb-0">1245 modificar</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="box-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h3 class="mb-0">145 modificar</h3>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-4 col-xxl-3">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-xxxl-12">
                    <div class="box">
                        <div class="box-body">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-xxxl-12">
                    <div class="box">
                        <div class="box-header middle">
                            <h3 class="box-title">Citas Medicas</h3>
                            {{-- <a class="btn btn-success pull-right" data-bs-toggle="tooltip" data-container="body" title="" data-bs-original-title="Nuevo Paciente" href="{{ route('posts.pacienteC') }}"><i class="fa fa-user-plus"></i></a> --}}
                        </div>
                        <div class="box-body">
                            <div class="table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                {{-- <div class="d-block text-dark flexbox">
                                                    <a id="" class="btn btn-success" data-bs-toggle="tooltip" data-container="body" title="" data-bs-original-title="Consultas" href="{{ route('posts.reciobosI') }}"><i class="mdi mdi-cash-multiple"></i></a>
                                                    <button type="button" id="btn_read" value="1" class="btn btn-info" data-bs-toggle="tooltip" data-container="body" data-bs-original-title="Ver Paciente"><i class="mdi mdi-eye"></i></button>
                                                    <a class="btn btn-secondary" data-bs-toggle="tooltip" data-container="body" title="" data-bs-original-title="Editar Paciente" href="{{ route('posts.pacienteU') }}"><i class="fa fa-edit"></i></a>
                                                </div> --}}
                                            </td>
                                        </tr>
                                        <tr>
