                    ...
                    <div class="row mb-3">
                        <div class="row invoice-info">
                            <div class="col-md-6 invoice-col">
                                <address>
                                    <strong class="text-blue fs-20">Proveedor: </strong><strong class="text-blue fs-20"
                                        id="proveedor"></strong> <br>
                                    <strong class="text-blue fs-20">Tipo de Movimiento: </strong><strong
                ...
                success: function(response) {
                    if (response.status === 200) {
                        ...
                        compraDetalles.forEach(function(detail) {
                            var vencimiento = !detail.vencimiento ? '' : moment(detail.vencimiento)
                                .format('DD-MM-YYYY');
