...
@section('content')
                                ...
                                <div class="col-xs-3col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3 col-xxxl-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="tipo" name="tipo" class="form-control select2">
                                            <option value="Venta" {{ $ventas->tipo == 'Venta' ? 'selected' : '' }}>Venta
                                            </option>
                                            <option value="Salida Directa"
                                                {{ $ventas->tipo == 'Salida Directa' ? 'selected' : '' }}>Salida Directa
                                            </option>
                                            <option value="Cuentas por Cobrar"
                                                {{ $ventas->tipo == 'Cuentas por Cobrar' ? 'selected' : '' }}>Cuentas por
                                                Cobrar</option>
                                        </select>
                                    </div>
                                    <!-- /.form-group -->
                                ...
                                <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2 col-xxxl-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="metodo_pago" name="metodo_pago" class="form-control select2">
                                            <option value="E" {{ $ventas->metodo_pago == 'E' ? 'selected' : '' }}>
                                                Efectivo</option>
                                            <option value="Q" {{ $ventas->metodo_pago == 'QR' ? 'selected' : '' }}>QR
                                            </option>
                                            <option value="M"
                                                {{ $ventas->metodo_pago == 'Efectivo y QR' ? 'selected' : '' }}>Efectivo y
                                                QR</option>
                                            <option value="N" {{ $ventas->metodo_pago == 'N' ? 'selected' : '' }}>
                                                Ninguno</option>
                                        </select>
                                    </div>
                                    <!-- /.form-group -->
                            ...
                            <div class="row" id="observacion_section">
                                ...
                                <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7 col-xl-7 col-xxl-7 col-xxxl-7">
                                    <div class="d-flex justify-content-between mt-15 pull-right">
                                        <button type="button" id="btn_editar_venta" value="{{ $ventas->id }}"
                                            class="btn btn-secondary" data-bs-toggle="tooltip" data-container="body"
                                            title="" data-bs-original-title="Editar Venta"><i
            ...
            <div class="box-body wizard-content">
                ...
                <section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <button type="button" id="btn_create_venta" class="btn btn-success pull-right"
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true" class="white-text">&times;</span></button>
                    </div>
                    <div class="modal-body" style="max-height: 500px; overflow-y: auto;">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-xxxl-12">
                                <div class="form-group">
                                    <label class="form-label">Cliente</label>
                                    <input type="text" value="{{ $ventas->cliente }}" id="cliente_update"
                                        name="cliente_update" class="form-control" placeholder="cliente_update">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-xxxl-12">
                                <div class="form-group">
                                    <label class="form-label">Observacion</label>
                                    <textarea type="text" id="observacion_update" name="observacion_update" class="form-control"
                                        placeholder="observacion_update">{{ isset($ventas) ? $ventas->observacion : old('observacion') }} </textarea>
    ...
    <div class="modal center-modal fade" id="modal-create-venta-detail" data-bs-backdrop="static" tabindex="-1"
        aria-hidden="true">
        ...
        <div class="modal-dialog" style="max-width: 900px">
            <form id="create_detalle" autocomplete="off">
                ...
                <div class="modal-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-xxxl-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" readonly="readonly" id="create_stock" class="form-control"
                                        name="create_stock">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-xxxl-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="create_precio_unitario" name="create_precio_unitario"
                                        min="0" pattern="\d+(\.\d{1,2})?" inputmode="decimal"
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-xxxl-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="create_cantidad" name="create_cantidad" min="1"
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-xxxl-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="create_subtotal_label" name="create_subtotal_label"
                    ...
                    <div class="modal-footer modal-footer-uniform">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cerrar</button>
                        <button type="submit" id="create_venta_detalle_btn"
        ...
        <div class="modal-dialog" style="max-width: 900px">
            <form id="edit_detalle" autocomplete="off">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-xxxl-6">
                                <div class="form-group">
                                    <label class="form-label">Producto</label>
                                    <input id="edit_producto_label" type="text" class="form-control"
                                        name="edit_producto_label" readonly>
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-xxxl-6">
                                <div class="form-group">
                                    <label class="form-label">Stock</label>
                                    <input id="edit_stock" type="number" readonly="readonly" id="stock"
                                        class="form-control" name="edit_stock">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-xxxl-4">
                                <div class="form-group">
                                    <label class="form-label">Precio Unitario</label>
                                    <input type="text" id="edit_precio_unitario" name="edit_precio_unitario"
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-xxxl-4">
                                <div class="form-group">
                                    <label class="form-label">Cantidad</label>
                                    <input type="number" id="edit_cantidad" name="edit_cantidad" min="1"
                                        class="form-control" placeholder="Cantidad">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-xxxl-4">
                                <div class="form-group">
                                    <label class="form-label">SubTotal</label>
                                    <input type="text" id="edit_subtotal_label" name="edit_subtotal_label"
                                        class="form-control" placeholder="Sub Total" readonly>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer modal-footer-uniform">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cerrar</button>
                        <button type="submit" id="edit_venta_detalle_btn"
                            class="btn btn-primary float-end">Guardar</button>
                    </div>
                </div>
            </form>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#create_cantidad').on('input', function() {
                let precio_unidad_create = parseFloat($("#create_precio_unitario").val()) || 0;
                let cantidad_create = parseFloat($("#create_cantidad").val()) || 0;
                let stock_disponible = parseFloat($('#create_stock').val()) || 0;
                if (cantidad_create > stock_disponible) {
                    alert("La cantidad supera las existencias");
                    cantidad_create = stock_disponible;
                    $('#create_cantidad').val(stock_disponible);
                }
                ...
                "columns": [{
...

                    {
                        ...
                        "mRender": function(data, type, row) {
                            ...
                            button += '<button type="button" id="btn_delete_venta_detail" value=' +
                                data.id +
                                ' class="waves-effect waves-light btn btn-danger mb-5" data-container="body" title="" data-bs-original-title="Eliminar"><i class="fa fa-bitbucket" aria-hidden="true"></i></button>';
            ...
            $('#update_ventas').on('submit', function(event) {
                ...
                $.ajax({
                    url: "{{ route('ventas.update', ':id') }}".replace(':id',
                        '{{ $ventas->id }}'),
                    type: 'POST',
                    data: formData,
            ...
            $('#edit_detalle').on('submit', function(event) {
                ...
                $.ajax({
                    url: "{{ route('ventaDetalle.update', ':id') }}".replace(':id',
                        venta_detalle_id),
                    type: 'POST',
                    data: formCreate,
                    success: function(response) {
            ...
            function validateEditDetail() {
                const edit_precio_unitario_value = parseFloat($('#edit_precio_unitario').val()) || 0;
                let edit_cantidad_value = parseFloat($('#edit_cantidad').val()) || 0;

                const edit_precio_unitario_filled = edit_precio_unitario_value > 0;
                let edit_cantidad_filled = edit_cantidad_value > 0;

                let anterior_cantidad = parseFloat($('#edit_cantidad_anterior').val()) || 0;
                let anterior_stock = parseFloat($('#edit_stock_anterior').val()) || 0;

                // Calcular stock disponible
                let stock_disponible = anterior_cantidad + anterior_stock;

                // Validar si excede el stock
                if (edit_cantidad_value > stock_disponible) {
                    alert("La cantidad excede las existencias");
                    edit_cantidad_value = stock_disponible;
                    $('#edit_cantidad').val(stock_disponible);
                }

                // Actualizar stock visual
                $('#edit_stock').val(stock_disponible - edit_cantidad_value);

                // CALCULAR SUBTOTAL CON LA CANTIDAD YA VALIDADA
                let subtotal = (edit_precio_unitario_value * edit_cantidad_value).toFixed(2);
                $('#edit_subtotal_label').val(subtotal);
                $('#edit_subtotal').val(subtotal);
