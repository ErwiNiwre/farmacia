        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-xxxl-12">
            <div class="box">
                <div class="box-header middle">
                    ...
                    <a class="btn btn-success pull-right" data-bs-toggle="tooltip" data-container="body" title="" data-bs-original-title="Nuevo Rol" href="{{ route('productos.create') }}"><i class="fa fa-plus"></i></a>
                </div>
                <div class="box-body">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-block text-dark flexbox">
                                            <button type="button" id="btn_read" value="{{ $producto->id }}" class="btn btn-info" data-bs-toggle="tooltip" data-container="body" data-bs-original-title="Ver Producto"><i class="mdi mdi-eye"></i></button>
                                            <a class="btn btn-secondary" data-bs-toggle="tooltip" data-container="body" title="" data-bs-original-title="Editar Produto" href="{{ route('productos.edit', $producto->id) }}"><i class="fa fa-edit"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
