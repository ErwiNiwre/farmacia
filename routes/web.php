...
Route::middleware('auth', 'verified')->group(function () {
   ...
   Route::get('/laboratorioServicios/{servicio}/show', [LaboratorioServicioController::class, 'show'])->name('laboratorioServicios.show');
   ...
   Route::delete('/laboratorioServicios/{servicio}', [LaboratorioServicioController::class, 'destroy'])->name('laboratorioServicios.destroy');
   ...
   Route::get('/compras/{compras}/print', [CompraController::class, 'print'])->name('compras.print');
